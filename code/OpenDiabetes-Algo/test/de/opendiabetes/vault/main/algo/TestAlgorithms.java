...
public class TestAlgorithms {
    ...
    public void disturbedDataTest(){
        ...
        algorithm = new FilterAlgo(absTime, insDur, testDataProvider);
        resultMeals = algorithm.calculateMeals();
        algorithm = new FilterAlgo(absTime, insDur, distDataProvider);
        disturbedMeals = algorithm.calculateMeals();
        for (VaultEntry meal: resultMeals){
            checkMealsAround(timeDelta, valueDelta, disturbedMeals, meal);
        }
        ...
        algorithm = new QRAlgo_TimeOpt(absTime, insDur, testDataProvider);
        resultMeals = algorithm.calculateMeals();
        algorithm = new QRAlgo_TimeOpt(absTime, insDur, distDataProvider);
        disturbedMeals = algorithm.calculateMeals();
        for (VaultEntry meal: resultMeals){
            //checkMealsAround(timeDelta, valueDelta, disturbedMeals, meal);
        }
        ...
        algorithm = new QRDiffAlgo(absTime, insDur, testDataProvider);
        resultMeals = algorithm.calculateMeals();
        algorithm = new QRDiffAlgo(absTime, insDur, distDataProvider);
        disturbedMeals = algorithm.calculateMeals();
        for (VaultEntry meal: resultMeals){
            checkMealsAround(timeDelta, valueDelta, disturbedMeals, meal);
        }
